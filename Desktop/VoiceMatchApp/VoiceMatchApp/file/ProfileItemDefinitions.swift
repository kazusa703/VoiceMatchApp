...
struct ProfileConstants {
    ...
    static let items: [ProfileItemDefinition] = [
        // 基本
        .init(key: "residence", displayName: "居住地", options: ["北海道", "東北", "関東", "中部", "近畿", "中国", "四国", "九州・沖縄", "海外"]),
        ...
        .init(key: "occupation", displayName: "職業", options: ["学生", "会社員", "公務員", "経営者・役員", "自営業", "フリーランス", "専門職", "医療関係", "IT関連", "飲食・サービス", "販売", "美容関係", "保育・教育", "福祉・介護", "主婦・主夫", "その他"]),
